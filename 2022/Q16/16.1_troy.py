...
def main(input_path: Path):
    ...
    for new_state in tqdm(curr_state.get_successors(dist, good_valves)):
        if new_state.is_end_state() and new_state.released_pressure > best_state.released_pressure:
